...
echo "CREATE DATABASE filinvestpoc;" | psql -h localhost -U postgres

echo "CREATE EXTENSION postgis;" | psql -h localhost -U postgres -d filinvestpoc

echo "GRANT ALL PRIVILEGES ON DATABASE filinvestpoc TO demouser;" | psql -h localhost -U postgres
